...
static const Licensee licensees[] = {
  {"00", "None"},
  {"01", "Nintendo R&D1"},
  {"08", "Capcom"},
...
static const CartridgeType cartridge_types[] = {
  {0x00, "ROM ONLY"},
  {0x01, "MBC1"},
  {0x02, "MBC1+RAM"},
...
static const OldLicensee old_licensees[] = {
  {0x00, "None"},
  {0x01, "Nintendo"},
  {0x08, "Capcom"},
  {0x09, "HOT-B"},
